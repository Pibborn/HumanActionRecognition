...
switch computer
    ...
    case 'PCWIN64'
        ...
        switch type
            case 'visualc'
                lib{1}=[matlabroot '\extern\lib\win64\microsoft\libmwlapack.lib'] ;
                lib{2}=[matlabroot '\extern\lib\win64\microsoft\msvc60\libmwlapack.lib'];
                lib{3}=[matlabroot '\extern\lib\win64\microsoft\msvc71\libmwlapack.lib'];
            case 'lcc'
                lib{1}=[matlabroot '\extern\lib\win64\lcc\libmwlapack.lib'] ;
        end
        found=0;
        for k=1:length(lib)
            fprintf('Trying LAPACK lib ''%s''\n',lib{k}) ;
