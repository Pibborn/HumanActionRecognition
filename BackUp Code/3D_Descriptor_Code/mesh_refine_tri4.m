...
for f = 1:Nface,
    ...
    % Store the midpoint vertices, 
    % while checking if midpoint vertex already exists
    tVertices = FV.vertices;
    [tVertices, Na] = mesh_find_vertex(tVertices,a);
    [tVertices, Nb] = mesh_find_vertex(tVertices,b);
    [tVertices, Nc] = mesh_find_vertex(tVertices,c);
    FV.vertices = tVertices;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [tempVertices, N] = mesh_find_vertex(vertices,vertex)
