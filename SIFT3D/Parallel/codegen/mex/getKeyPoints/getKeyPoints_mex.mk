...
MAKEFILE = getKeyPoints_mex.mk

include getKeyPoints_mex.mki
...
SRC_FILES =  \
	...
	getKeyPoints.c \
	_coder_getKeyPoints_info.c \
	_coder_getKeyPoints_api.c \
	_coder_getKeyPoints_mex.c \
	getKeyPoints_emxutil.c

MEX_FILE_NAME_WO_EXT = getKeyPoints_mex
...
SYS_INCLUDE += -I "$(START_DIR)\codegen\mex\getKeyPoints"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\getKeyPoints/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\getKeyPoints/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\getKeyPoints/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
