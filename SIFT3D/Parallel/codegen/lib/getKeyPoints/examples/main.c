...
static emxArray_real_T *c_argInit_UnboundedxUnboundedxU(void)
{
  ...
  result = emxCreateND_real_T(4, iv0);
...
static void main_getKeyPoints(void)
{
  ...
  emxArray_real_T *I;
  emxInitArray_real_T(&keyPoints, 2);

  /* Initialize function 'getKeyPoints' input arguments. */
  /* Initialize function input argument 'I'. */
  I = c_argInit_UnboundedxUnboundedxU();

  /* Call the entry-point 'getKeyPoints'. */
  getKeyPoints(I, argInit_real_T(), argInit_real_T(), keyPoints);
  emxDestroyArray_real_T(keyPoints);
