...
filePath = 'C:\Users\ygarg\Dropbox (ASU)\sift3D\Results\Weizmann\Descriptor\SIFT3DDes\Final\';
resultPath = 'C:\Users\ygarg\Dropbox (ASU)\sift3D\Results\Weizmann\Vocab_feature_loc\';
...
for word = 1 : length(wordSizes)
    ...
    toc;
    signatureFileName = strcat(num2str(wordSizes(word)),'_SIFT3DDescriptor.csv');
