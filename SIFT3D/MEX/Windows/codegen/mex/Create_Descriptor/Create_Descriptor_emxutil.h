 ...
 *
 * Create_Descriptor_emxutil.h
 *
 * Code generation for function 'Create_Descriptor_emxutil'
 *
 */

#ifndef __CREATE_DESCRIPTOR_EMXUTIL_H__
#define __CREATE_DESCRIPTOR_EMXUTIL_H__
...
/* End of code generation (Create_Descriptor_emxutil.h) */
