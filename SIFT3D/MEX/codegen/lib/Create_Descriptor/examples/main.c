...
#include "Create_Descriptor_emxAPI.h"
...
static void main_Create_Descriptor(void);
...
static void main_Create_Descriptor(void)
{
  ...
  /* Initialize function 'Create_Descriptor' input arguments. */
  /* Initialize function input argument 'pix'. */
  pix = c_argInit_UnboundedxUnboundedxU();

  /* Call the entry-point 'Create_Descriptor'. */
  Create_Descriptor(pix, argInit_real_T(), argInit_real_T(), argInit_real_T(),
                    argInit_real_T(), argInit_real_T(), &keyPoint, &reRun);
  emxDestroyArray_real_T(pix);
}
