 ...
 * File: _coder_getKeyPoints_api.c
 *
...
emlrtContext emlrtContextGlobal = { true, false, 131419U, NULL, "getKeyPoints",
 ...
 * Return Type  : void
 */
void getKeyPoints_api(const mxArray *prhs[3], const mxArray *plhs[1])
{
  emxArray_real_T *I;
  ...
  emxInit_real_T(&st, &I, 4, true);
  emxInit_real_T1(&st, &keyPoints, 2, true);
  ...
  getKeyPoints(I, o, thresh, keyPoints);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(keyPoints);
...
/*
 * File trailer for _coder_getKeyPoints_api.c
 *
 * [EOF]
 */
